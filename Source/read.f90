...
NAMELIST /DUMP/ CFL_FILE,CLIP_RESTART_FILES,COLUMN_DUMP_LIMIT,CTRL_COLUMN_LIMIT,DEVC_COLUMN_LIMIT,&
                ...
                T_DEVC_LINE_END,TURB_INIT_CLOCK,VELOCITY_ERROR_FILE,WRITE_XYZ
...
LOGICAL :: INITIAL_STATE, LATCH, STATE_PID, PREV_STATE_PID
INTEGER :: N,NC,TRIP_DIRECTION
REAL(EB) :: SETPOINT(2), DELAY,CONSTANT,PROPORTIONAL_GAIN,INTEGRAL_GAIN,DIFFERENTIAL_GAIN,TARGET_VALUE,UPPER_PID,LOWER_PID,PERCENTILE!,DT_SAMPLING
...
NAMELIST /CTRL/  CONSTANT,DELAY,DIFFERENTIAL_GAIN,FUNCTION_TYPE,ID,INITIAL_STATE,&
                 ...
                 SETPOINT,TARGET_VALUE,TRIP_DIRECTION,UPPER_PID,LOWER_PID!,DT_SAMPLING
...
!   CF%DT_SAMPLING = DT_SAMPLING
   CF%UPPER_PID = UPPER_PID
   CF%LOWER_PID = LOWER_PID
